...
const fake = {
  key: {
    participant: '6289508242211@s.whatsapp.net',
    remoteJid: '6289508242211@s.whatsapp.net'
  },
  message: { conversation: await style('Backup Script', 5) }
}
let backupZip = 'noelle.zip'
...
archive.pipe(output);
archive.glob('**/*', {
    ignore: ['node_modules/**', 'noelle.zip'] // Mengecualikan folder node_modules
});
